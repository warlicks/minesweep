import unittest
import numpy as np
from warlick_minesweep import extract_field_dimensions
...
class MyMinesweeperTests(unittest.TestCase):
    ...
    def test_parse_field_dimensions_range(self):
        ...
        self.mine_map = open("mines.txt", "r")
        self.field_rows, self.field_cols = extract_field_dimensions(self.mine_map)
        self.assertGreater(self.field_rows, -1, "Row value is not greater than 0.") # Asserting that number test is > 0 
    ...
    def test_parse_field_dimensions_greater_101(self): # allows for acceptence 101 in the code / program
    ...
    def test_parse_field_dimensions_negative_value(self): # allows for acceptence -1 in the code / program
